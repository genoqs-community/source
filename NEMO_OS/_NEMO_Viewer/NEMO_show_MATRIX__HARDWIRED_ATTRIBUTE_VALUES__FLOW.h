		...
		switch( NEMO_selectedTrackAttribute ){
			...
			case NEMO_ATTR_POSITION:		
				...
				MIR_write_trackpattern(   Page_get_chord_trackpattern( target_page, row )
										| Page_get_event_trackpattern( target_page, row ), 
										NEMO_ROW_I, MIR_RED   );	
				MIR_augment_trackpattern( Page_get_skippattern(  target_page, row ), NEMO_ROW_I, MIR_RED   );
				MIR_augment_trackpattern( Page_get_selection_trackpattern( target_page, row ), NEMO_ROW_I, MIR_BLINK );
				j = 11;
				break;
			...
			case NEMO_ATTR_GROOVE:		
				MIR_fill_numeric 	(	1, target_page->Track[row]->attr_GRV + 1, 	0,	MIR_RED);
				MIR_fill_numeric 	(	1, target_page->Track[row]->attr_GRV + 1, 	0,	MIR_GREEN);
				j = 6;
				break;
