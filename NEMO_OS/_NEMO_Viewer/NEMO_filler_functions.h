...
// Show the dice speed nudge value of step as horizontal bar
void MIR_show_dice_speed_nudge_bar_H( unsigned char number, unsigned char target_row ){

	signed char shift = number - 6;

	MIR_fill_numeric( 4, 5, target_row, MIR_GREEN 	);
	MIR_fill_numeric( 9, 5, target_row, MIR_RED 	);
...
void MIR_write_subdiv_LEN( unsigned char length, unsigned char target_row ) {
	...
	MIR[RHS][target_row][MIR_RED] |= 1 << length;
