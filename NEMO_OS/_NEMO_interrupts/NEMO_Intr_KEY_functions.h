...
unsigned int NEMO_computeKeyNdx (	unsigned char reg,  
...
// d_iag_printf( "reg:%d portValue:0x%x row:%d\n", reg, portValue, row );

	// Implement the NEMO keyindex map, as outlined on paper
	switch( reg ){
	
		// Stop and ESC
		case 20:
			switch( portValue ){
				case 0x40:	ndx = 230; 	break;
				case 0x20:	ndx = 185; 	break;
			}
			break;

		case 18:
			switch( row ){
				case 2:		ndx = 228; 	break;
				case 3:		ndx = 226;	break;
				case 4:		ndx = 217;	break;
			}			
			break;

		case 17:
			switch( row ){
				case 2:		ndx = 221;	break;
				case 3:		ndx = 219;	break;
				case 4:		ndx = 218;	break;
			}
			break;		
		...
		default:
			switch( row ){	
				case 0:
					// Row 0 has a special index blend..
					switch( reg ){			
						case 0:		ndx = 20;		break;
						case 1: 	ndx = 31;		break;
						case 2:		ndx = 0;		break;
						...
						case 8:		ndx = 64; 		break;
						case 9:		ndx = 75;		break;
						case 10:	ndx = 222;		break;
						case 11:	ndx = 231;		break;
						case 12:	ndx = 240;		break;
						case 13:	ndx = 163;		break;
						case 14:	ndx = 174;		break;
						case 18:	ndx = 228;		break;
					}
					break;
