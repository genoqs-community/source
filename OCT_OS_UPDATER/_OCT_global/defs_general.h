...
#define 	SW_VERSION_MAJOR				 0	// Max 10
#define		SW_VERSION_MINOR				 9	// Max 10
#define		SW_VERSION_RELEASE				 9	// Max 10

#define		SW_VERSION_INTERNAL				 9	// Max 16 - Row 0 number
...
#define		RECORDING			3	// used in Cadence context for recording status
#define 	PLAYING				2	// used in Cadence context for playback status
...
#define TRACK_NROF_ATTRIBUTES	16

// The number of key that a cadence can store
#define CADENCE_NROF_KEYS		160	
...
// KEYMODES defines - to be replaced by zoom modes where possible
#define		KMOD_PAGE					0
#define		KMOD_THIS_TRACK				1
#define 	KMOD_THIS_TRACK_EXTENDED	10
#define 	KMOD_THIS_STEP				2
#define 	KMOD_ATTR_MAP				7
#define 	KMOD_GRID					8
// #define 	KMOD_CADENCE_EDIT			9
...
#define 	ELE_TEMPO_MULTIPLIER	12
...
#define 	GLOBAL_LOCATOR_PICTURE	19
...
#define		MIX2EDIT				3		// Copy of MIX functionality with selected attribute (attr_mix2edit)
...
#define		_GENOQS_SYSEX_BASE		0x00206400
#define		_OS_SYSEX_DUMP			0x00
#define		_CONFIGFILE_SYSEX_DUMP	0x01
#define 	_PAGE_SYSEX_DUMP		0x10
#define 	_BANK_SYSEX_DUMP		0x20
#define		_GRID_SYSEX_DUMP		0x30
#define 	_FULL_SYSEX_DUMP		0x40
