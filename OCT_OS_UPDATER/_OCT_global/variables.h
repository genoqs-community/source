...
unsigned char CHAINS_PLAY_HEAD = ON;
...
unsigned char* 		sysex_stream_keeper;
unsigned int		sysex_stream_keeper_index = 0;

#define				OSFILE_SIZE						0x70000
#define 			CONFIGFILE_SIZE					0x10000
...
// The values are finally divided by the middle value..
#define FACTOR_NEUTRAL_VALUE 	50
