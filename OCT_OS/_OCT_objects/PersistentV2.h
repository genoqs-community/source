...
#ifndef PERSISTENTV2_H_
#define PERSISTENTV2_H_
...
typedef struct {
	...
	card16 				version;			// Must be 2.
	card16 				sizeBt;				// Size of struct PagePersistentV2.
	card16 				pageCheckSum;		// Card16 checksum (simply adding) of all struct bytes, with this field initially set to 0.

	TrackPersistentV2 	Track[ MATRIX_NROF_ROWS ];
	StepPersistentV2 	Step[ MATRIX_NROF_ROWS ][ MATRIX_NROF_COLUMNS ];
...
typedef struct {
	...
	card8 randomizer;
} TriggerStackPersistentV2;


// Direction structure
typedef struct {
	TriggerStackPersistentV2 trigger_set[17];
} TrackDirectionPersistentV2;
...
typedef struct {
	...
	card16 		version;			// Must be 2.
	card16 		sizeBt;				// Size of struct GridPersistentV2.
	...
	TrackDirectionPersistentV2 	direction_repository[17];
	PagePersistentV2 			assistant_page;
...
typedef struct {
	...
	// Meta data.
	card16 		magic1;				// Must be PERSISTENT_SCENE_MAGIC1.
	card16 		magic2;				// Must be PERSISTENT_SCENE_MAGIC2.
	card16 		version;			// Must be 2.
	card16 		sizeBt;				// Size of struct ScenePersistentV2.
	card16 		sceneCheckSum;		// Card16 checksum (simply adding) of all struct bytes, with this field initially set to 0.
...
// Function prototypes.
extern void PersistentV2_GridExport( GridPersistentV2* targetGridPt );
extern void PersistentV2_GridImport( const GridPersistentV2* sourceGridPt );
extern void PersistentV2_PageExport( const Pagestruct* sourcePagePt, PagePersistentV2* targetPagePt);
extern void PersistentV2_PageImport(const PagePersistentV2* sourcePagePt, Pagestruct* targetPagePt);
extern void PersistentV2_SceneExport( ScenePersistentV2* targetScenePt );
extern void PersistentV2_SceneImport( const ScenePersistentV2* sourceScenePt );
extern void PersistentV2_GridInit( GridPersistentV2* gridPt );
extern void PersistentV2_PageInit( PagePersistentV2* pagePt );
extern void PersistentV2_SceneInit( ScenePersistentV2* gridPt );
extern void PersistentV2_TrackInit( TrackPersistentV2* targetTrackPt );
extern void PersistentV2_StepInit( StepPersistentV2* targetStepPt );
extern void PersistentV2_TrackAndStepExport(const Pagestruct* sourcePagePt, card32 source_row, PagePersistentV2* targetPagePt);
extern void PersistentV2_TrackAndStepImport( Pagestruct* targetPagePt, card32 source_row, const PagePersistentV2* sourcePagePt );
extern void PersistentV2_TrackAndStepImport( Pagestruct* targetPagePt, card32 source_row, const PagePersistentV2* sourcePagePt );
extern void PersistentV2_StepExport( const Stepstruct* sourceStepPt, StepPersistentV2* targetStepPt );
extern void PersistentV2_StepImport( const StepPersistentV2* sourceStepPt, Stepstruct* targetStepPt );




#endif /*PERSISTENTV2_H_*/
