...
// 32 pitch segment from 1 to 4 NOTE_OFF messages
...
unsigned char G_num_card [10][10] = // bitmaps for the big numbers
			{	{ 0, 24, 36, 66, 129, 129, 66, 36, 24, 0 }, // '0'
				{ 0, 12, 8, 8, 8, 8, 8, 8, 28, 0 },			// '1'
				{ 0, 60, 66, 66, 32, 16, 8, 4, 126, 0 },	// '2'
				{ 0, 28, 34, 32, 16, 8, 16, 34, 28, 0, },	// '3'
				{ 0, 34, 34, 34, 126, 32, 32, 32, 32, 0 },	// '4'
				{ 0, 62, 2, 2, 28, 32, 32, 34, 28, 0 },		// '5'
				{ 0, 56, 68, 2, 2, 58, 70, 36, 24, 0 },		// '6'
				{ 0, 124, 66, 64, 32, 56, 8, 4, 2, 0 },		// '7'
				{ 0, 28, 34, 34, 20, 8, 20, 34, 28, 0 },	// '8'
				{ 0, 28, 34, 34, 60, 32, 32, 32, 32, 0 },	// '9'
				{},
			};
#endif
