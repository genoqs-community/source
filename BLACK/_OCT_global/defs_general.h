...
#define		SW_VERSION_RELEASE				 9
#define		SW_VERSION_INTERNAL				 7
...
#define		MIN_TEMPO						 1		// MIN selectable tempo value
...
#define 	KMOD_PLAY					3
#define 	KMOD_MIXER_MAP				5
#define 	KMOD_THIS_PAGE				6
...
// Used as indexes in the Track->offStep array
...
#define 	MIDI_CC					2
#define		MIDI_CLOCK				3
#define 	MIDI_LOAD				4		// Used in Viewer for MIDI mbox peek
