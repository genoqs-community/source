...
#define PAGE_DEF_VELOCITY		0
#define PAGE_MIN_VELOCITY		0
#define PAGE_MAX_VELOCITY		127
...
#define TRACK_DEF_RANGE_VEL		127		// Track Modulation RANGE values 
#define TRACK_MIN_RANGE_VEL		0
#define TRACK_MAX_RANGE_VEL		127

#define TRACK_MIN_VELFACTOR		0
#define TRACK_MAX_VELFACTOR		10
#define TRACK_DEF_VELFACTOR		5


#define TRACK_DEF_PITCH			60		// Handled in the code - assignment ongoing
#define TRACK_MIN_PITCH			0
#define TRACK_MAX_PITCH			127
#define TRACK_DEF_RANGE_PIT		127		// Track Modulation RANGE values 
#define TRACK_MIN_RANGE_PIT		0
#define TRACK_MAX_RANGE_PIT		127

#define TRACK_MIN_PITFACTOR		0
#define TRACK_MAX_PITFACTOR		10
#define TRACK_DEF_PITFACTOR		5
...
#define TRACK_MAX_LENFACTOR		10
#define TRACK_DEF_LENFACTOR		5
...
#define TRACK_MAX_STAFACTOR		10
#define TRACK_DEF_STAFACTOR		5
...
#define TRACK_MAX_GRVFACTOR		10
#define TRACK_DEF_GRVFACTOR		5



#define TRACK_MIN_MIDICC		-1
...
#define TRACK_MAX_MCCFACTOR		10
#define TRACK_DEF_MCCFACTOR		5
...
#define TRACK_MAX_MIDICH		32		// 1-16 are MIDI 1, 17-32 are MIDI 2 
...
#define STEP_MIN_AMOUNT			-127
#define STEP_MAX_AMOUNT			127
