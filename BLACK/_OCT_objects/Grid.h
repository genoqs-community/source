...
// unsigned char 	GRID_row_selected = 0;
...
// unsigned short  GRID_bank_mutepattern = 0;
// unsigned short 	GRID_bank_mutepattern_stored = 0;
...
// BELOW NOW HANDLED BY THE GRID ASSISTANT PAGE
// These are the GRID CC MAPS - they are generally assignable
// unsigned char GRID_CC_MIXMAP[6][10][3];
// unsigned char GRID_CC_MIXMAP_attribute;		// Indicates which attribute is shown for GRID_CC_MIXMAPS
// unsigned char GRID_mixTarget = MIXTGT_USR0;	// Specifies the mix knob target in GRID mode.
