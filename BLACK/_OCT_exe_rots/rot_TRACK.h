	...
	if ( rotNdx == 0 ){
		...
		switch( VIEWER_page->trackAttributeSelection ){
			...
			case 0:
				...
				i = my_bit2ndx( VIEWER_page->trackSelection );
				modify_parameter( 	&VIEWER_page->Track[i]->program_change, 
				...
				if ( is_pressed_key( KEY_PROGRAM ) ){
					...
					MIDI_send( 	MIDI_PGMCH, 
						...
						VIEWER_page->Track[i]->program_change - 1, 
						0 );
				}				
				break;
			...
			case ( 1 << 0 ):
				// Modify VEL range
				modify_parameter( 	&VIEWER_page->Track[ my_bit2ndx( VIEWER_page->trackSelection )]->VEL_factor, 
									TRACK_MIN_VELFACTOR, 
									TRACK_MAX_VELFACTOR, 
									direction, OFF, FIXED );
				break;
			...
			case ( 1 << 1 ):
				// Modify PIT range
				modify_parameter( 	&VIEWER_page->Track[ my_bit2ndx( VIEWER_page->trackSelection )]->PIT_factor, 
									TRACK_MIN_PITFACTOR, 
									TRACK_MAX_PITFACTOR, 
									direction, OFF, FIXED );
				break;
			...
			case ( 1 << 2 ):
				// Modify LEN range
				modify_parameter( 	&VIEWER_page->Track[ my_bit2ndx( VIEWER_page->trackSelection )]->LEN_factor, 
									TRACK_MIN_LENFACTOR, 
									TRACK_MAX_LENFACTOR, 
									direction, OFF, FIXED );
				break;
			...
			case ( 1 << 3 ):
				// Modify STA range
				modify_parameter( 	&VIEWER_page->Track[ my_bit2ndx( VIEWER_page->trackSelection )]->STA_factor, 
									TRACK_MIN_STAFACTOR, 
									TRACK_MAX_STAFACTOR, 
									direction, OFF, FIXED );
				break;
			...
			case ( 1 << 7 ):
				// Modify GRV range
				modify_parameter( 	&VIEWER_page->Track[ my_bit2ndx( VIEWER_page->trackSelection )]->GRV_factor, 
									TRACK_MIN_GRVFACTOR, 
									TRACK_MAX_GRVFACTOR, 
									direction, OFF, FIXED );
				break;
			...
			case ( 1 << 8 ):
				...
				modify_parameter( 	&VIEWER_page->Track[ my_bit2ndx( VIEWER_page->trackSelection )]->MCC_factor, 
									TRACK_MIN_MCCFACTOR, 
									TRACK_MAX_MCCFACTOR, 
									direction, OFF, FIXED );
				break;
