		...
		if ( rotNdx == 0 ){
			...
			switch( VIEWER_page->trackAttributeSelection ){
				...
				case ( 1 << VELOCITY ):
					...
					modify_parameter( 
						&VIEWER_page->Track[row]->VEL_factor, 
				...
				case ( 1 << PITCH ):
					...
					modify_parameter( 
						&VIEWER_page->Track[row]->PIT_factor, 
				...
				case ( 1 << LENGTH ):
					...
					modify_parameter( 
						&VIEWER_page->Track[row]->LEN_factor, 
				...
				case ( 1 << START ):
					...
					modify_parameter( 
						&VIEWER_page->Track[row]->STA_factor, 
				...
				case ( 1 << GROOVE ):
					...
					modify_parameter( 
						&VIEWER_page->Track[row]->GRV_factor, 
				...
				case ( 1 << MIDICC ):
					...
					modify_parameter( 
						&VIEWER_page->Track[row]->MCC_factor, 
